...
import com.java.example.entity.TbComment;
import org.apache.ibatis.annotations.Param;
import org.springframework.data.domain.Pageable;
import java.util.List;

/**
 * 评论表(TbComment)表数据库访问层
 *
 * @author makejava
 * @since 2022-07-21 15:14:17
 */
public interface TbCommentDao {
     ...
     * @return 对象列表
     */
    List<TbComment> queryAllByLimit(TbComment tbComment, @Param("pageable") Pageable pageable);
     ...
     * @return 总行数
     */
    long count(TbComment tbComment);
